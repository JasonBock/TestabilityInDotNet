...
namespace TestabilityInDotNet.Exploratory
{
	/// <summary>
	/// See:
	...
	/// https://techcrunch.com/2008/12/31/the-day-the-zunes-stood-still-update/
	/// </summary>
	public static class RealTimeClock
	{
		...
		private static int GetDayOfWeek(uint days) => 
			(int)((days - 1 + JAN1WEEK) % 7);
